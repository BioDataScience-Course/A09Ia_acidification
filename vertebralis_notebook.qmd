...
<!--# Les conditions sont pour rappel les suivantes : 'n' pour naturel, 't' pour temp. élevée, 'p' pour pH bas et 'tp' pour les deux.  -->
...
growth1_anova <- ___
___(growth1_anova) |> tabularise(origdata = growth1)
```
...
```{r normal1, record='RNCS', arg='no.data'}
___
```
...
```{r anova2, warning=FALSE, record='ROP', object='growth2_anova', arg='terms'}
growth2_anova <- ___
___(growth2_anova) |> tabularise(origdata =growth2)
```
...
```{r normal2, record='RNCS', arg='no.data'}
___
```
...
select_answer(r"-{
select_answer(r"-{
[] -   En absence de l’hôte *L. intricata*, aucune des conditions expérimentales ne modifie significativement la croissance de *M. vertebralis*.
[] -   En absence de l’hôte *L. intricata*, un pH bas entraîne une baisse significative de la croissance.
[] -   En absence de l’hôte *L. intricata*, la température élevée réduit significativement la croissance.
[] -   En absence de l’hôte, la combinaison pH bas + température élevée produit l’effet négatif le plus marqué.

[] -   En présence de *L. intricata*, aucune des conditions expérimentales ne modifie significativement la croissance de *M. vertebralis*.
[] -   En présence de *L. intricata*, un pH bas entraîne une baisse significative de la croissance.
[] -   En présence de *L. intricata*, la température élevée réduit significativement la croissance.
[] -   En absence de l’hôte, la combinaison pH bas + température élevée produit l’effet négatif le plus marqué.

[] -   L’hôte *L. intricata* semble amortir ou compenser l’effet négatif d’un pH bas sur la croissance du foraminifère.
[] -   La présence de l’hôte *L. intricata* amplifie les effets du pH bas et de la température.
}-")
```
